...
public class Program {
	...
	private static List<Profissional> listaFuncionario = new ArrayList<>();
	...
	public static void main(String[] args) {
		...
		//Definindo horario de trabalho do salão
		listaHorariosDoSalao(horaInicio, horaFim);
		
		//Criando instancia e adicionando os serviços
		...
		//Criando instancia dos profissionais e adicionando funcionarios
		Profissional profissional = new Profissional();
		
		profissional = new Profissional("Alexandre");
		listaFuncionario.add(profissional);
		
		profissional = new Profissional( "Rodrigo");
		listaFuncionario.add(profissional);
		
		profissional = new Profissional("Lucas");
		listaFuncionario.add(profissional);
		...
		i = 0;
		for (Profissional profissionais : listaFuncionario) {
			System.out.println("[ " + i + " ] " + profissionais.getNome());
			i++;
		}
		System.out.println();
		...
		agendamento.setProfissional(listaFuncionario.get(indexProfissional));
